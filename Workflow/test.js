...
test('./encode.js "中文&\\$>"', {
  items: [
    ...
    { uid: 'MD5', icon: { path: './icons/Encode_MD5.png' }, title: '8930740309a30f25d2acced86f6bf813', subtitle: '编码 MD5', arg: '8930740309a30f25d2acced86f6bf813' },
  ]
});
...
test('./encode.js "https://github.com/CYJB/Alfred-Workflow-Encode_Decode?1234567890中123文%6422=qwertyuiopsdfghp[;./.,lkjhzxcvbnm,.测试，。￥！@#访问方法"', {
  items: [
    ...
    { uid: 'MD5', icon: { path: './icons/Encode_MD5.png' }, title: '524be65835103079959f7822905c845c', subtitle: '编码 MD5', arg: '524be65835103079959f7822905c845c' },
  ]
});
